...
import { mstCrmInvoices } from "../../services/graphql";
const InvoicesList = (props) => {
  ...
  const [fetchInvoices, { loading: invoiceLoading, data: invoicesData }] =
    useLazyQuery(mstCrmInvoices);
  ...
  useEffect(() => {
    if (invoicesData && invoicesData.mstCrmInvoices) {
      setInvoiceList(invoicesData.mstCrmInvoices.data);
    }
  }, [invoicesData]);
