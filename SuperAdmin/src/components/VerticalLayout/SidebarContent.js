      ...
      >
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/edit-events" className="has-arrow waves-effect">
            ...
            <li>
              <Link to="/edit-cme" className="has-arrow waves-effect">
            ...
            <li>
              <Link to="/edit-gallery" className="has-arrow waves-effect">
            ...
            {/* <li>
              <Link to="/add-featured-videos" className="waves-effect">
            ...
            <li>
              <Link to="/add-top-stories" className="waves-effect">
            ...
            <li>
              <Link to="/add-advertisement" className="waves-effect">
            ...
            <li>
              <Link to="/president" className="waves-effect">
                <i className="uil-cloud-bookmark"></i>
                <span>{props.t("President")}</span>
              </Link>
            </li>
            <li>
              <Link to="/specialists" className="waves-effect">
                <i className="uil-cloud-bookmark"></i>
                <span>{props.t("Specialists")}</span>
              </Link>
            </li>
            <li>
            ...
            {/* <li>
              <Link to="/pending-request" className="waves-effect">
                <i className="uil-newspaper"></i>
                <span>{props.t("Pending Request")}</span>
              </Link>
            </li> */}
