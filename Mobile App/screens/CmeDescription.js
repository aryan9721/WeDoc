...
import CarouselCme from "../CarouselCme";
import { useRoute } from "@react-navigation/native";
// import MapView, { Marker } from "react-native-maps";
import { useNavigation } from "@react-navigation/native";
import useApiKeyStore from "./store";

export default function CmeDescription() {
  const navigation = useNavigation();

  const route = useRoute();
  const cme = route.params ? route.params.cme : {};
  ...
  const handleRegister = () => {
    console.log(`${BACKEND_URL}/api/cme/${cme._id}`);
    ...
    fetch(`${BACKEND_URL}/api/cme/${cme._id}`, requestOptions)
      .then((response) => {response.text();
        console.log('success regier');
            ...
            <View style={styles.container}>
              ...
              >
                ...
                >
                  {cme && (
                    <Text>
                      {new Date(cme.startDateTime).toLocaleTimeString([], {
                        hour: "2-digit",
                        minute: "2-digit",
                        hour12: true,
                      })}
          ...
          />
            ...
            <View style={styles.container}>
              <View>
                ...
                >
                  {cme && cme.registeredUser.length} + People Joined:
                </Text>
              </View>
            </View>
            <View>
